...
<form method="POST" action="change.php">
    <table border="0" width="60%">
        ...
        <tr><td width="30%">Password: </td><td><input type="text" name="newpassword" value="<?php echo $_REQUEST['pwds'];?>"></td></tr>
    </table>
    <input type="submit" value="Save & Update">
    <input type="hidden" name="id" value="<?php echo $_REQUEST['userids'];?>">
</form>
</body>
</html>